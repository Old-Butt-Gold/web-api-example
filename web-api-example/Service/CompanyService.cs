...
internal sealed class CompanyService : ICompanyService
{
    ...
    public async Task<IEnumerable<CompanyDto>> GetAllCompaniesAsync(bool trackChanges)
    {
        var companies = await _repository.
            Company.GetAllCompaniesAsync(trackChanges);
    ...
    public async Task<ApiBaseResponse> GetAllCompaniesAsyncFlow(bool trackChanges)
    {
        ...
        (IEnumerable<CompanyForCreationDto> companyCollection)
    {
        ...
        var companies = _mapper.Map<IEnumerable<CompanyDto>>(companyEntities);
